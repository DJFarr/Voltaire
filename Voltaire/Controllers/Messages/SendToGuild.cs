...
namespace Voltaire.Controllers.Messages
{
    class SendToGuild
    {
        ...
        public static async Task LookupAndSendAsync(SocketGuild guild, ShardedCommandContext context, string channelName, string message, bool replyable, DataBase db)
        {
            ...
            {
                await Send.SendErrorWithDeleteReaction(context.Channel, "The channel you specified couldn't be found. Please specify your desired channel before your message: `send (channel_name) (message)` ex: `send some-channel Nothing is true, everything is permitted.`");
                return;
            }
